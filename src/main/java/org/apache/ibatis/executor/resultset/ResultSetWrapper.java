 ...
 * @author Iwao AVE!
 *         结果集包装类
 *         包装类涉及到 jdbc - java类型的转化
 *         针对ResultSet 包装一层操作
 *         也就是一个映射了~     例如      tableColumn -? 数据库查询出来的别名   猜测
 */
public class ResultSetWrapper {
	...
	/**
	 * 数据库column name 这三个list 是对应关系
	 * 多个数据 映射到一起使用什么数据类型比较好
	 */
	 ...
	 *
	 * 直接通过 类型 和 列名 来获取对应的 typeHandler
	 *
	 * @param propertyType
	 * @param columnName
	 * @return
	...
	/**
	 * 通过 ResultMap 和 columnPrefix 来加载到
	 * mappedColumnNamesMap     unMappedColumnNamesMap   中
	 * 类实例
	 * @param resultMap
	 * @param columnPrefix
	 * @throws SQLException
