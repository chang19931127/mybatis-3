 ...
 * 管理类 超强 强行适配SqlSessionFacotyr 和 SqlSession
 * 可以理解 直接管理SqlSessionFacotyr
 *
 * 这个类应该是提供给使用者的类
 * 可以理解下设计就好,后期我们统一 通过实例debug 来深入一波
 */
public class SqlSessionManager implements SqlSessionFactory, SqlSession {

	/**
	 * 内部维护SqlSessionFactory
	 */
